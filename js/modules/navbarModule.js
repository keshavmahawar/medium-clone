...
export default function navLoad() {
    ...
    if(user){
        $set("navbarRight").innerHTML=`<a class="nav-link text-dark text-dark-custom font-heading-custom mr-1" href="logout.html">${user} </a> <i class="fa fa-user-circle" style="font-size: 25px;" aria-hidden="true"></i>`
    }else{
